    ...
    <>
      <section className="page-hero">
        <div className="container">
          ...
          <h1>Digital Store</h1>
          <p>
            eBooks and Audiobooks — delivered instantly to your email after purchase.
            Available worldwide, no shipping required.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          {/* ===== DELIVERY INFO ===== */}
          <div style={{
            marginTop: 70, background: "var(--sand)",
            ...
            <div className="grid-3">
              ...
              <div>
                ...
                <p style={{ opacity: 0.7 }}>Pay with card, bank transfer, or USSD via Selar — Nigeria's trusted digital store platform.</p>
              </div>
              <div>
                <div style={{ fontSize: "2rem", marginBottom: 12 }}>📧</div>
                <h3>3. Download instantly</h3>
                <p style={{ opacity: 0.7 }}>Your download link arrives in your email immediately after payment. No waiting.</p>
              </div>
            </div>
          </div>
