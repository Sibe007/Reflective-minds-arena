    ...
    .map((e) => ({
      ...
      location:
        e.type === "webinar"
          ...
          : {
              "@type": "Place",
              name: e.location || "Location to be announced",
            },
      organizer: {
        "@type": "Person",
        name: "Solomon B. Ibe",
    ...
    <>
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <h1>Events</h1>
          <p>
            Speaking engagements, book launches, webinars, and public
            appearances.
          </p>
        </div>
      </section>
        ...
        <div className="container" style={{ maxWidth: 760 }}>
          {webinars.length > 0 && (
            <>
              ...
              <h2 style={{ marginTop: 14, marginBottom: 32 }}>
                Join live, online
              </h2>
          ...
          <div style={{ marginTop: 70 }}>
            ...
            <h2 style={{ marginTop: 14, marginBottom: 20 }}>
              Book Solomon for your event
            </h2>

            <p style={{ opacity: 0.8, fontSize: "1.05rem" }}>
              Solomon B. Ibe is available for speaking engagements, panel
              discussions, literary festivals, university lectures, and
              corporate events on topics including:
            </p>
            ...
            >
              <li>
                The Architecture of Belief — how societies construct the minds
                inside them
              </li>
              <li>
                African storytelling traditions and their relevance today
              </li>
              <li>
                Independent publishing in Nigeria and across Africa
              </li>
