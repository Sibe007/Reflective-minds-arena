...
export default function AdminLoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Same message either way — see note in the API route
    }
    setStatus("done");
  }
    ...
    return (
      <section className="page-hero" style={{ minHeight: "50vh", display: "flex", alignItems: "center" }}>
        <div className="container" style={{ textAlign: "center", maxWidth: 480, margin: "0 auto" }}>
          ...
          <p>
            If that email is an admin address, a sign-in link is on its way.
    ...
    <section className="page-hero" style={{ minHeight: "50vh", display: "flex", alignItems: "center" }}>
      <div className="container" style={{ maxWidth: 420, margin: "0 auto" }}>
        ...
        <p style={{ marginBottom: 24 }}>
          Enter your admin email and we'll send you a sign-in link — no password needed.
        </p>
